...
%%% outputFile = sprintf('/Volumes/gold/cinn/2020/gbgaba/GBGABA_BIDS/derivatives/MRS/analysis/group_analysis_MC/group_analysis_MC.mat');
%%% or for OCC, run:
%%% outputFile = sprintf('/Volumes/gold/cinn/2020/gbgaba/GBGABA_BIDS/derivatives/MRS/analysis/group_analysis_OCC/group_analysis_OCC.mat');
